...
genNoteCfg halfStepsFromA440 =
    ...
    let lightness = toFloat (50 + (2 * halfStepsFromA440)) in 

    ( name
    , { freq = freq, gain = gain, halfStepsFromA440 = halfStepsFromA440, name = name, color = HSLuv.hsluv { hue = hue, saturation = 100.0, lightness = lightness, alpha = 0 } }
    )
